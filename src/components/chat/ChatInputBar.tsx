...
export function ChatInputBar({ onSendMessage, isLoading }: ChatInputBarProps) {
  ...
  return (
    <div 
      ref={inputBarRef} 
      className="border-t border-border/30 bg-background/70 p-3 shadow-md backdrop-blur-md"
    >
      {selectedFile && (
      ...
      <div className="flex items-end gap-2"> 
        <Textarea
          ...
          className="flex-1 resize-none rounded-lg border-border/50 bg-input/50 p-3 text-base shadow-inner focus:ring-primary/50 glassmorphic-input max-h-60 overflow-y-auto" // max-h increased
          rows={1}
          disabled={isLoading}
        />
        <div className="flex flex-row items-center gap-2"> 
          ...
          <Button
            ...
            className="bg-primary/90 hover:bg-primary text-primary-foreground aspect-square md:aspect-auto md:px-4 py-2.5 shadow-md hover:shadow-primary/40 transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center"
